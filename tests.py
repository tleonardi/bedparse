...
class KnownValues(unittest.TestCase):
    ...
    def test_promoter(self):
        ...
        for ((bed), (prom)) in self.known_promoters:
            result = bedClass.bedLine(bed).promoter()
            self.assertEqual(result, bedClass.bedLine(prom))
    ...
    def test_promoter100(self):
        ...
        for ((bed), (prom)) in self.known_promoters100:
            result = bedClass.bedLine(bed).promoter(up=100, down=100)
            self.assertEqual(result, bedClass.bedLine(prom))
